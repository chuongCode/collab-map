...
export default function InspectorPanel({
  ...
  // user list dropdown is now a separate component (handles its own open/close and
  // scroll-to-current behavior). userListRef remains for any external needs.
